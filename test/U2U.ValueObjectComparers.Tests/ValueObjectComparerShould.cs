...
public class ValueObjectComparerShould
{
  ...
  public ValueObjectComparerShould(ITestOutputHelper output) => this.output = output;
...
#pragma warning restore CS1718 // Comparison made to same variable
  ...
  public void ReturnSameHashCodeForEqualObjects()
  {
    ...
    this.output.WriteLine($"# obj1 = {obj1.GetHashCode()}");
    this.output.WriteLine($"# obj2 = {obj2.GetHashCode()}");
...
#pragma warning restore CS1718 // Comparison made to same variable
  ...
  {
    var someDate = new DateTime(2020, 03, 31);
